...
class FluksoapiTest(unittest.TestCase):
    ...
    def test_consolidate(self):
        ...
        self.assertTrue(np.isnan(ts1.loc['2014-01-08 08:00:00'][1]))       
        ...
        self.assertEqual(ts.loc['2014-01-08 08:00:00'][1], 1120.0, "Last file should overwrite identical indices")
        os.remove(new_csv)
    ...
    def test_consolidate_day(self):
        ...
        ts = fluksoapi.load_csv(new_csv)        
        self.assertEqual(ts.index[0], ts1.index[0])
        self.assertEqual(ts.index[-1], dt.datetime(2014,1,8,0,0,0))
